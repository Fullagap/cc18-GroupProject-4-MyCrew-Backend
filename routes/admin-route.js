...
const { register, updateUser, getUserById, getDepartment, getPositionEachDepartment, getEmployeeInDepartment
    , getEachSuperId, getLeaderEachSupId, getSupIdByDepartment, allEmployees, createDepartment, createPosition,getHeader,getLeadSupId,updateImageProfile } = require("../controllers/admin-controller")
...
router.clo("/admin/superId-employees/:id", authCheck, adminCheck, getEachSuperId)
...
router.post("/admin/create-department",authCheck,adminCheck, createDepartment)
