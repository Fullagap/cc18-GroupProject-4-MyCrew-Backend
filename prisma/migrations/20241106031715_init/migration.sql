...
CREATE TABLE `user` (
    ...
    `dateEnd` DATE NULL,
    `annual_leave_amount` DOUBLE NOT NULL,
    `sick_leave_amount` INTEGER NULL DEFAULT 30,
    `personal_leave_amount` INTEGER NULL DEFAULT 3,
    `annual_leave` DOUBLE NOT NULL,
    `sick_leave` INTEGER NULL DEFAULT 30,
    `personal_leave` INTEGER NULL DEFAULT 3,
